...
* [Wiki](https://github.com/Albrecht-Ohsiek/ffmpeg-kit/wiki) includes most detailed documentation we have
* [Discussions](https://github.com/Albrecht-Ohsiek/ffmpeg-kit/discussions) is where we expect you to ask questions
* [Issues](https://github.com/Albrecht-Ohsiek/ffmpeg-kit/issues) is for bugs and issues

## Reporting Bugs

Bugs are tracked as [GitHub issues](https://github.com/Albrecht-Ohsiek/ffmpeg-kit/issues). We have a `Bug report` issue 
...
under the [ffmpeg-kit-test](https://github.com/Albrecht-Ohsiek/ffmpeg-kit-test) repository.
